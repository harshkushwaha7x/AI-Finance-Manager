...
import type { GoalSavedView, GoalSavedViewId } from "@/types/goals";

type GoalSavedViewsProps = {
  views: GoalSavedView[];
  activeView: GoalSavedViewId;
  onSelect: (viewId: GoalSavedViewId) => void;
};

export function GoalSavedViews({ views, activeView, onSelect }: GoalSavedViewsProps) {
  return (
    <section className="space-y-4">
      <div>
        ...
        <h3 className="mt-3 font-display text-3xl font-bold tracking-tight text-foreground">
          Jump between active, urgent, and completed goals fast
        </h3>
      </div>
